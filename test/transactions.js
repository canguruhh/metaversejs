...
describe('Transactions', function() {
    ...
    it('Sign asset transaction with attenuation model', () => {
        ...
        tx.inputs[0].address='tCdbgEP2kNS9qAoSnRnoN6nDMhvCugNVgZ'
        tx.inputs[0].previous_output.address='tCdbgEP2kNS9qAoSnRnoN6nDMhvCugNVgZ'
        tx.inputs[1].address='tJYz6PJtVoqWEqrRF3nWP6mZQ7dbxTK3dS'
        tx.inputs[1].previous_output.address='tJYz6PJtVoqWEqrRF3nWP6mZQ7dbxTK3dS'
        return Metaverse.wallet.fromMnemonic("lunar there win define minor shadow damage lounge bitter abstract sail alcohol yellow left lift vapor tourist rent gloom sustain gym dry congress zero", 'testnet')
            .then((wallet) => wallet.sign(tx))
            .then((stx) => stx.encode())
            .then((signed_raw_tx) => signed_raw_tx.toString('hex'))
            .should.become("");
    });
